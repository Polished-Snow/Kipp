...
compute-bound, not traffic-bound). Remaining: long-context prefill
attention (the dominant cost above ~8K tokens now that projections are
fast), quantized tensor-matmul variants, server prefill chunk tuning, a
